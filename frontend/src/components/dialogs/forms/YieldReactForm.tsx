...
export default function YieldReactForm({ op, update }: OpFormProps) {
  const r = reader(op)
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Heat of reaction (J/mol)">
          <NumberInput
            value={r.num('heatOfReactionJPerMol')}
            onChange={(v) => update({ heatOfReactionJPerMol: v })}
          />
        </Field>
      </div>
